    ...
    <>
      ...
      >
        <ContentBox
          ...
          category={category}
          description={`
        A Freestanding rompe com o tradicional e apresenta o novo conceito de cozinha como equipamento. Composta por unidades independentes, a linha foi desenhada para seguir corretamente a dinâmica 
        do workflow ideal para cozinhas, respeitando as áreas de trabalho e o posicionamento dos acessórios. Cada unidade independente dispõe de área úmida e de cocção e compartimentos com excelente 
        espaço para armazenamento e organização, permitindo que utensílios e acessórios estejam à mão.
        Além disso, a Freestanding é produzida em aço inoxidável 304, combinado com materiais refinados que conferem um acabamento elegante e sofisticado, sem interferir na composição do ambiente. 
        Logo a linha se encaixa perfeitamente em diversos projetos de cozinha, assumindo, também, o papel de solução ideal para ambientes como sacadas e varandas gourmet, áreas cobertas para piscina, 
        áreas para churrasqueira e cozinhas com espaço limitado Muito mais flexibilidade, durabilidade e resistência, permitindo, até mesmo, que a cozinha seja levada com você no caso de mudança de casa.
                `}
